...
const (
	...
	UserService_Authorize_FullMethodName = "/UserService/Authorize"
)
...
type UserServiceClient interface {
	...
	Authorize(ctx context.Context, in *AuthorizationRequest, opts ...grpc.CallOption) (*User, error)
}
...
func (c *userServiceClient) Authorize(ctx context.Context, in *AuthorizationRequest, opts ...grpc.CallOption) (*User, error) {
	out := new(User)
...
type UserServiceServer interface {
	...
	Authorize(context.Context, *AuthorizationRequest) (*User, error)
...
func (UnimplementedUserServiceServer) Authorize(context.Context, *AuthorizationRequest) (*User, error) {
